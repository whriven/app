  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" 
            ...
            :key="address.id"
            @click="changeDefaultAddress(address,userAddressInfo)">
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul class="list clearFix" v-for="(trade,index) in detailList" :key="trade.skuId">
          <li>
    ...
    <div class="money clearFix">
      <ul>
        <li>
          <b><i>{{detailList.length}}</i>件商品，总商品金额</b>
...
export default {
  ...
  computed: {
    // 用户地址信息
    userAddressInfo() {
      return this.$store.state.trade.addressInfo || [];
    },
    // 商品清单列表
    detailList() {
  ...
  methods: {
    // 修改默认地址
    changeDefaultAddress(address, userAddressInfo) {
